 ...
 * @author RRAAAA
 */
@WebServlet(name = "laporanDepartemenView", urlPatterns = {"/laporanDepartemenView"})
public class laporanDepartemenView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("menuLaporanDepartemenView.jsp");
        }
    }
