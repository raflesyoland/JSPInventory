 ...
 * @author RRAAAA
 */
@WebServlet(name = "laporanManajerViewServlet", urlPatterns = {"/laporanManajerViewServlet"})
public class laporanManajerViewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("menuLaporanManajerView.jsp");
        }
    }
